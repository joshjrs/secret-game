...
class LocationControllerTest extends TestCase
{
    ...
    public function testClosestSecrets()
    {
        ...
        // $this->assertTrue(empty(array_diff_assoc(['name' => 'amber'], $currentElement)));
        $this->assertArraySubset(['name' => 'amber'], $currentElement);

        // Second
        $currentElement = array_shift($closestSecrets);
        // $this->assertTrue(empty(array_diff_assoc(['name' => 'ruby'], $currentElement)));
        $this->assertArraySubset(['name' => 'ruby'], $currentElement);

        // Third
        $currentElement = array_shift($closestSecrets);
        // $this->assertTrue(empty(array_diff_assoc(['name' => 'diamond'], $currentElement)));
